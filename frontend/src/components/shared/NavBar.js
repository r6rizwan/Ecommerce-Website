...
const Navbar = () => {
  ...
  const showSearch = location.pathname !== "/super-admin/login" && !isUserHome;
      ...
      <nav className="navbar navbar-expand-lg sticky-top bg-white border-bottom shadow-sm">
        <div className="container-xl">
          ...
          <div className="collapse navbar-collapse" id="navbarNav">
            <ul className="navbar-nav ms-auto align-items-lg-center nav-links-compact">
              {showSearch && (
                ...
                <>
                  ...
                  <li className="nav-item cart-nav">
                    <NavLink to="/usercart" className="nav-link cart-link">
                      ...
                      {!utype && <span className="cart-text">Cart</span>}
                    </NavLink>
                  </li>
                </>
              )}
